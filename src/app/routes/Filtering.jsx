...
// Anonymous (no active project) CSV cache -- IndexedDB, not localStorage
import {
  loadLocalCacheFile,
  saveLocalCacheFile,
  clearLocalCacheFile,
} from "../../services/localCacheFile";
        ...
        complete: async (res) => {
          try {
            ...
            if (projectId) {
              ...
              await saveLocalCacheFile({ data, headers, filename: file.name || "" });
            }
          } catch (err) {
            console.error(err);
